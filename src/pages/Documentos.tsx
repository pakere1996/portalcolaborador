...
type DocumentoComTipo = Documento & {
  tipo: Tables<'documentos'>['tipo'];
};

export default function DocumentosPage() {
  const { user } = useAuth();
  const [docs, setDocs] = useState<DocumentoComTipo[]>([]);
  ...
  const loadDocuments = useCallback(async () => {
    ...
    try {
      ...
      setDocs(data as DocumentoComTipo[]);
    } catch (e) {
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="space-y-4">
              ...
              ))}<dyad-write path="src/pages/Documentos.tsx" description="Creating the Documentos page for collaborators to view and download their own Contracheques and Folhas de Ponto.">
"use client";
